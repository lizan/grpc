...
typedef grpc_alts_HandshakeProtocol grpc_alts_handshake_protocol;
typedef grpc_alts_NetworkProtocol grpc_alts_network_protocol;
typedef grpc_alts_Identity grpc_alts_identity;
typedef grpc_alts_NextHandshakeMessageReq grpc_alts_next_handshake_message_req;
typedef grpc_alts_ServerHandshakeParameters grpc_alts_server_handshake_parameters;
typedef grpc_alts_Endpoint grpc_alts_endpoint;
typedef grpc_alts_StartServerHandshakeReq_HandshakeParametersEntry
    grpc_alts_handshake_parameters_entry;
typedef grpc_alts_StartClientHandshakeReq grpc_alts_start_client_handshake_req;
typedef grpc_alts_StartServerHandshakeReq grpc_alts_start_server_handshake_req;
typedef grpc_alts_HandshakerReq grpc_alts_handshaker_req;
typedef grpc_alts_HandshakerResult grpc_alts_handshaker_result;
typedef grpc_alts_HandshakerStatus grpc_alts_handshaker_status;
typedef grpc_alts_HandshakerResp grpc_alts_handshaker_resp;

typedef enum {
  CLIENT_START_REQ = 0, /* StartClientHandshakeReq. */
  SERVER_START_REQ = 1, /* StartServerHandshakeReq. */
  NEXT_REQ = 2,         /* NextHandshakeMessageReq. */
} grpc_alts_handshaker_req_type;
 ...
 * grpc_alts_identity type fields.
 *
 * - head: a head of repeated field list.
 */
...
/**
 * This method is an encode callback function for a repeated grpc_alts_identity
 * field.
 */
...
bool decode_string_or_bytes_cb(pb_istream_t* stream, const pb_field_t* field,
                               void** arg);
/**
 * This method is a decode callback function for a repeated grpc_alts_identity
 * field.
 */
