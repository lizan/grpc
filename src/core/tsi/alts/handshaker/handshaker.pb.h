...
#define _grpc_gcp_HandshakeProtocol_MIN \
  grpc_gcp_HandshakeProtocol_HANDSHAKE_PROTOCOL_UNSPECIFIED
#define _grpc_gcp_HandshakeProtocol_MAX grpc_gcp_HandshakeProtocol_ALTS
#define _grpc_gcp_HandshakeProtocol_ARRAYSIZE \
  ((grpc_gcp_HandshakeProtocol)(grpc_gcp_HandshakeProtocol_ALTS + 1))
...
#define _grpc_gcp_NetworkProtocol_MIN \
  grpc_gcp_NetworkProtocol_NETWORK_PROTOCOL_UNSPECIFIED
#define _grpc_gcp_NetworkProtocol_MAX grpc_gcp_NetworkProtocol_UDP
#define _grpc_gcp_NetworkProtocol_ARRAYSIZE \
  ((grpc_gcp_NetworkProtocol)(grpc_gcp_NetworkProtocol_UDP + 1))
...
#define grpc_gcp_Endpoint_init_default \
  { {{nullptr}, nullptr}, false, 0, false, (grpc_gcp_NetworkProtocol)0 }
#define grpc_gcp_Identity_init_default          \
  {                                              \
    {{nullptr}, nullptr}, { {nullptr}, nullptr } \
  }
#define grpc_gcp_StartClientHandshakeReq_init_default           \
  {                                                              \
    false, (grpc_gcp_HandshakeProtocol)0, {{nullptr}, nullptr}, \
        {{nullptr}, nullptr}, {{nullptr}, nullptr}, false,       \
        grpc_gcp_Identity_init_default, false,                  \
        grpc_gcp_Endpoint_init_default, false,                  \
        grpc_gcp_Endpoint_init_default,                         \
        grpc_gcp_RpcProtocolVersions_init_default               \
  }
#define grpc_gcp_ServerHandshakeParameters_init_default \
  {                                                      \
    {{nullptr}, nullptr}, { {nullptr}, nullptr }         \
  }
#define grpc_gcp_StartServerHandshakeReq_HandshakeParametersEntry_init_default \
  { false, 0, false, grpc_gcp_ServerHandshakeParameters_init_default }
#define grpc_gcp_NextHandshakeMessageReq_init_default \
  {                                                    \
    { {nullptr}, nullptr }                             \
  }
#define grpc_gcp_HandshakerReq_init_default                      \
  {                                                               \
    false, grpc_gcp_StartClientHandshakeReq_init_default, false, \
        grpc_gcp_StartServerHandshakeReq_init_default, false,    \
        grpc_gcp_NextHandshakeMessageReq_init_default            \
  }
#define grpc_gcp_HandshakerResult_init_default                              \
  {                                                                          \
    {{nullptr}, nullptr}, {{nullptr}, nullptr}, {{nullptr}, nullptr}, false, \
        grpc_gcp_Identity_init_default, false,                              \
        grpc_gcp_Identity_init_default, false, 0,                           \
        grpc_gcp_RpcProtocolVersions_init_default                           \
  }
#define grpc_gcp_HandshakerStatus_init_default \
  {                                             \
    false, 0, { {nullptr}, nullptr }            \
  }
#define grpc_gcp_HandshakerResp_init_default           \
  {                                                     \
    {{nullptr}, nullptr}, false, 0, false,              \
        grpc_gcp_HandshakerResult_init_default, false, \
        grpc_gcp_HandshakerStatus_init_default         \
  }
#define grpc_gcp_Endpoint_init_zero \
  { {{nullptr}, nullptr}, false, 0, false, (grpc_gcp_NetworkProtocol)0 }
#define grpc_gcp_Identity_init_zero             \
  {                                              \
    {{nullptr}, nullptr}, { {nullptr}, nullptr } \
  }
#define grpc_gcp_StartClientHandshakeReq_init_zero                        \
  {                                                                        \
    false, (grpc_gcp_HandshakeProtocol)0, {{nullptr}, nullptr},           \
        {{nullptr}, nullptr}, {{nullptr}, nullptr}, false,                 \
        grpc_gcp_Identity_init_zero, false, grpc_gcp_Endpoint_init_zero, \
        false, grpc_gcp_Endpoint_init_zero, {                             \
      {nullptr}, nullptr, grpc_gcp_RpcProtocolVersions_init_zero          \
    }                                                                      \
  }
#define grpc_gcp_ServerHandshakeParameters_init_zero \
  {                                                   \
    {{nullptr}, nullptr}, { {nullptr}, nullptr }      \
  }
#define grpc_gcp_StartServerHandshakeReq_init_zero                             \
  {                                                                             \
    {{nullptr}, nullptr}, 0,                                                    \
        {grpc_gcp_StartServerHandshakeReq_HandshakeParametersEntry_init_zero,  \
         grpc_gcp_StartServerHandshakeReq_HandshakeParametersEntry_init_zero,  \
         grpc_gcp_StartServerHandshakeReq_HandshakeParametersEntry_init_zero}, \
        {{nullptr}, nullptr}, false, grpc_gcp_Endpoint_init_zero, false,       \
        grpc_gcp_Endpoint_init_zero, grpc_gcp_RpcProtocolVersions_init_zero   \
  }
#define grpc_gcp_StartServerHandshakeReq_HandshakeParametersEntry_init_zero \
  { false, 0, false, grpc_gcp_ServerHandshakeParameters_init_zero }
#define grpc_gcp_NextHandshakeMessageReq_init_zero \
  {                                                 \
    { {nullptr}, nullptr }                          \
  }
#define grpc_gcp_HandshakerReq_init_zero                      \
  {                                                            \
    false, grpc_gcp_StartClientHandshakeReq_init_zero, false, \
        grpc_gcp_StartServerHandshakeReq_init_zero, false,    \
        grpc_gcp_NextHandshakeMessageReq_init_zero            \
  }
#define grpc_gcp_HandshakerResult_init_zero                                 \
  {                                                                          \
    {{nullptr}, nullptr}, {{nullptr}, nullptr}, {{nullptr}, nullptr}, false, \
        grpc_gcp_Identity_init_zero, false, grpc_gcp_Identity_init_zero,   \
        false, 0, grpc_gcp_RpcProtocolVersions_init_zero                    \
  }
#define grpc_gcp_HandshakerStatus_init_zero \
  {                                          \
    false, 0, { {nullptr}, nullptr }         \
  }
#define grpc_gcp_HandshakerResp_init_zero           \
  {                                                  \
    {{nullptr}, nullptr}, false, 0, false,           \
        grpc_gcp_HandshakerResult_init_zero, false, \
        grpc_gcp_HandshakerStatus_init_zero         \
  }
...
#define grpc_gcp_StartServerHandshakeReq_HandshakeParametersEntry_size \
  (17 + grpc_gcp_ServerHandshakeParameters_size)
/* grpc_gcp_NextHandshakeMessageReq_size depends on runtime parameters */
#define grpc_gcp_HandshakerReq_size             \
  (18 + grpc_gcp_StartClientHandshakeReq_size + \
   grpc_gcp_StartServerHandshakeReq_size +      \
   grpc_gcp_NextHandshakeMessageReq_size)
...
#endif  // PB_GRPC_GCP_HANDSHAKER_PB_H_INCLUDED
